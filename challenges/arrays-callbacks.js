...
const lowCaseAnimalNames = zooAnimals.map(function(item){return item.animal_name.toLowerCase();});
...
*/
const lowPopulationAnimals = zooAnimals.filter(function(item){return item.population < 5;});
